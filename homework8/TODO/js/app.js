...
form.addEventListener('submit', function (e) {
    ...
    if (!title.value || !text.value) {
        alertMessage('No title or text', 'danger') // danger
        return;
    }
    ...
    if (dataTaskId) {
        ...
        alertMessage('Todo was edited') // info
    } else {
        addNewTodoToStorage(title.value, text.value);
        alertMessage('New todo was added') // info
    }
...
function deleteTodoFromView(id) {
    ...
    alertMessage('Todo was deleted') // info
}
...
function alertTemplate(message, className = 'info') {
